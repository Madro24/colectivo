package com.sstacorp.colectivo.security.authentication.provider;
...
public class LimitLoginAuthenticationProvider extends DaoAuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		try {
			...
			// this user is locked!
			String error = "";
			LoginHistory userAttempts = userDetailsDao.getUserAttempts(authentication.getName());

			if (userAttempts != null) {
				Date lastAttempts = userAttempts.getLastLogin();
